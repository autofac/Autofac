...
<xsl:stylesheet version="1.0"
	...
	<xsl:import href="instrumentedlink-zh-CN.xslt" />
	<xsl:import href="ps-instrumentedlink.xslt" />
	<xsl:import href="ps-languageSpecificText.xslt" />
	<!--<xsl:import href="nestedtable.xslt" />-->
	<xsl:import href="codesnippet-zh-CN.xslt" />
	<xsl:import href="ps-codesnippet.xslt" />
	<xsl:import href="MultiViewTable-zh-CN.xslt" />
	<xsl:import href="search-zh-CN.xslt" />
	<xsl:import href="index-zh-CN.xslt" />
	<xsl:import href="toc-zh-CN.xslt" />
</xsl:stylesheet>