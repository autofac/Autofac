...
#pragma warning disable SA1402 // File may only contain a single type - smoke test fixtures.

/// <summary>
/// A simple service contract used to verify interface-to-implementation resolution.
/// </summary>
...
/// <summary>
/// Default implementation of <see cref="IDependency"/>.
/// </summary>
...
/// <summary>
/// Keyed implementation of <see cref="IDependency"/> used to verify keyed resolution.
/// </summary>
internal sealed class KeyedDependency : IDependency
{
}
...
/// <summary>
/// Registered only inside a child lifetime scope.
/// </summary>
internal sealed class ScopedService
{
}
