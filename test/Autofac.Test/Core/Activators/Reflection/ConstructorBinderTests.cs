...
public class ConstructorBinderTests
{
    ...
    public void WhenAnExceptionIsThrownFromAConstructor_TheInnerExceptionIsWrapped()
    {
        ...
        var cpb = new ConstructorBinder(ci, DefaultReflectionCache.Shared).Bind(Enumerable.Empty<Parameter>(), new ContainerBuilder().Build());
    ...
    public void WhenPrimitiveTypeIsProvidedForPrimitiveParameterConversionWillBeAttempted()
    {
        ...
        var cpb = new ConstructorBinder(ci, DefaultReflectionCache.Shared).Bind(new[] { new PositionalParameter(0, 1), }, new ContainerBuilder().Build());
    ...
    public void WhenEnumTypeIsProvidedForIntParameterConversionWillBeAttempted()
    {
        ...
        var cpb = new ConstructorBinder(ci, DefaultReflectionCache.Shared).Bind(new[] { new PositionalParameter(0, Foo.B), }, new ContainerBuilder().Build());
    ...
    public void WhenUsingByRefParameterExceptionIsThrownForIllegalParameter() // added for issue 1126
    {
        ...
        var constructorBinder = new ConstructorBinder(constructorInfo, DefaultReflectionCache.Shared);
