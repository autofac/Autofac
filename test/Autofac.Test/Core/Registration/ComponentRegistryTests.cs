...
public class ComponentRegistryTests
{
    ...
    {
        var registryBuilder = Factory.CreateEmptyComponentRegistryBuilder();
        registryBuilder.AddRegistrationSource(new MetaRegistrationSource(new ReflectionCache()));
    ...
    public void AdaptingAGeneratedServiceYieldsASingleAdapter()
    {
        var registryBuilder = Factory.CreateEmptyComponentRegistryBuilder();
        registryBuilder.AddRegistrationSource(new MetaRegistrationSource(new ReflectionCache()));
        registryBuilder.AddRegistrationSource(new CollectionRegistrationSource(new ReflectionCache()));
        var registry = registryBuilder.Build();
