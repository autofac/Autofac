...
namespace Autofac {
    ...
    internal class RegistrationExtensionsResources {
        ...
        /// <summary>
        ///   Looks up a localized string similar to The type &apos;{0}&apos; is not an open generic interface type..
        /// </summary>
        internal static string NotOpenGenericInterfaceType {
            get {
                return ResourceManager.GetString("NotOpenGenericInterfaceType", resourceCulture);
            }
        }
    }
}
