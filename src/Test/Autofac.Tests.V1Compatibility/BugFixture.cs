        ...
        public void IncorrectExceptionThrown1()
        {
            ...
            catch (DependencyResolutionException de)
            {
                Assert.IsTrue(de.Message.Contains(
                    "Autofac.Tests.V1Compatibility.BugFixture+ID -> Autofac.Tests.V1Compatibility.BugFixture+IA -> Autofac.Tests.V1Compatibility.BugFixture+IC -> Autofac.Tests.V1Compatibility.BugFixture+IA"));
            }
            catch (Exception ex)
            {
